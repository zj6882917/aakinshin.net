...
<section id="experience">
  ...
  <table class="table-ok">
    ...
    <tr>
      ...
      <td>
        <span class="myemph">Аспирант</span> по специальности <a href="http://www.altstu.ru/media/f/051318_OOP_ispr.pdf">05.13.18</a> «Математическое моделирование, численные методы и комплексы программ». Диссертация «Математическое и численное моделирование искусственных регуляторных контуров генных сетей» (защита в <a href="http://www.sscc.ru/">ИВМиМГ СО РАН</a>, <a href="http://www.sscc.ru/Diss_sov/D02_2013.12.17.html">декабрь 2013</a>).
      </td>
    </tr>
  </table>
  ...
  <p><i>Lead Software Developer</i></p>
  <b>Навыки</b>
  <table class="table-ok">
    <tr>
  ...
  <ul>
    ...
    <li>
      <img class="favimage" src="/img/icons/ppa.png" alt="" />
      <a href="http://www1.fips.ru/fips_servl/fips_servlet?DB=EVM&rn=673&DocNumber=2013660415&TypeFile=html">Phase Portrait Analyzer</a>:
      Программа для расчёта и анализа фазовых портретов динамических систем специального вида, свидетельство о государственной регистрации программы для ЭВМ №2013660415
    </li>
  </ul>
</section>
...
<section id="talks">
  ...
  <b>Конференции</b>
  <ul>
    <li>Всероссийская конференция по .NET технологиям <a href="http://dotnext.ru/">«.NEXT 2014 Moscow»</a>,<br />
